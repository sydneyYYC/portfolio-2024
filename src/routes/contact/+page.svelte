...
<body class=" flex min-h-screen w-screen m-0 overflow-x-hidden">
  ...
  <div class="lg:ml-[8rem] self-start my-[2rem] mr-[2rem] w-0 lg:w-auto">
...
<!-- form section -->
  <section class="self-start flex flex-col overflow-x-hidden ml-0 mt-6 w-[80%] lg:w-[40%]">
    <h3 class=" text-4xl lg:text-6xl mb-6 mr-6 ml-6 lg:my-[1.7rem]">Contact Me</h3>
